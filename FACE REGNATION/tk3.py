...
def start_recognition():
    ...
    cooldown_frames = 0
    fake_attempts = set()  # Store faces flagged as fake
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if name in fake_attempts:
                ...
                continue  # Skip further checks for this face
            ...
            if blink_count >= 2 and head_moved and cooldown_frames == 0:
                if confidence < 100:
                ...
                fake_attempts.add(name)  # Permanently block this face
